(function() {
  ...
  class Emitter {
    constructor(options) {
      ...
      this._leakageMon = ((_a2 = this._options) === null || _a2 === void 0 ? void 0 : _a2.leakWarningThreshold) ? new LeakageMonitor((_c = (_b2 = this._options) === null || _b2 === void 0 ? void 0 : _b2.leakWarningThreshold) !== null && _c !== void 0 ? _c : _globalLeakWarningThreshold) : void 0;
            ...
            if (s.node === node && !s.inverted && s.schema) {
              ...
              if (parentKey !== void 0) {
                ...
                if (s.schema.patternProperties && !propertyMatched) {
                  for (var _a2 = 0, _b2 = Object.keys(s.schema.patternProperties); _a2 < _b2.length; _a2++) {
                    var pattern = _b2[_a2];
    ...
    function() {
      ...
      FilePatternAssociation2.prototype.matchesPattern = function(fileName) {
        ...
        for (var _i = 0, _a2 = this.globWrappers; _i < _a2.length; _i++) {
          var _b2 = _a2[_i], regexp = _b2.regexp, include = _b2.include;
